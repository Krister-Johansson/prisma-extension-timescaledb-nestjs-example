...
- compare — overlay ONE group+type metric across consecutive equal-length periods, aligned for comparison (period-over-period). config: { title?, groupId, typeKey, agg:"AVG"|"MIN"|"MAX", amount:<int>, unit:"day"|"week", count:2-6 }. Use for "compare the last N weeks/days" or "week over week". E.g. "compare the last 6 weeks of indoor temperature" → { groupId:<House>, typeKey:"TEMPERATURE", agg:"AVG", amount:1, unit:"week", count:6 }.
